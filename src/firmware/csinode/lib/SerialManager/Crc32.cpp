...
// IEEE 802.3 CRC-32 (polynomial 0x04C11DB7, reflected form 0xEDB88320).
// Initial value 0xFFFFFFFF, final XOR 0xFFFFFFFF.
// This table is generated at compile time and stored in flash.
static constexpr uint32_t s_crcTable[256] =
{
...
{
    return ~update(0xFFFFFFFF, data, len);
}
